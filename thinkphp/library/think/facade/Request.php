 ...
 * @method mixed param(string $name = '', mixed $default = null, mixed $filter = null) static 获取当前请求的参数
 * @method mixed route(string $name = '', mixed $default = null, mixed $filter = null) static 设置获取路由参数
 * @method mixed get(string $name = '', mixed $default = null, mixed $filter = null) static 设置获取GET参数
 * @method mixed post(string $name = '', mixed $default = null, mixed $filter = null) static 设置获取POST参数
 * @method mixed put(string $name = '', mixed $default = null, mixed $filter = null) static 设置获取PUT参数
 * @method mixed delete(string $name = '', mixed $default = null, mixed $filter = null) static 设置获取DELETE参数
 * @method mixed patch(string $name = '', mixed $default = null, mixed $filter = null) static 设置获取PATCH参数
 * @method mixed request(string $name = '', mixed $default = null, mixed $filter = null) static 获取request变量
 * @method mixed session(string $name = '', mixed $default = null, mixed $filter = null) static 获取session数据
 * @method mixed cookie(string $name = '', mixed $default = null, mixed $filter = null) static 获取cookie参数
 * @method mixed server(string $name = '', mixed $default = null, mixed $filter = null) static 获取server参数
 * @method mixed env(string $name = '', mixed $default = null, mixed $filter = null) static 获取环境变量
